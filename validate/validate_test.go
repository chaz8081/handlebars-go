...
func TestValidate_AllPresent(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{"name": "World"}, nil)
	if len(errs) != 0 {
...
func TestValidate_MissingRequired(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{"firstName": "Alice"}, nil)
...
func TestValidate_MissingMultiple(t *testing.T) {
	tpl := handlebars.MustParse("{{a}} {{b}} {{c}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"b": "present"}, nil)
...
func TestValidate_ConditionFalsy_SkipsConditional(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{"premium": false}, nil)
	if len(errs) != 0 {
...
func TestValidate_ConditionTruthy_ChecksConditional(t *testing.T) {
	tpl := handlebars.MustParse("{{#if premium}}{{billing.plan}}{{/if}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"premium": true}, nil)
	assertValidationHasError(t, errs, "billing.plan")
}

func TestValidate_ConditionMissing(t *testing.T) {
	tpl := handlebars.MustParse("{{#if premium}}{{billing.plan}}{{/if}}")
	errs := Validate(tpl.AST(), map[string]interface{}{}, nil)
...
func TestValidate_ElseBranch(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{"active": false}, nil)
...
func TestValidate_ElseBranch_Truthy(t *testing.T) {
	tpl := handlebars.MustParse("{{#if active}}{{name}}{{else}}{{fallbackName}}{{/if}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"active": true}, nil)
...
func TestValidate_NestedConditions(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{"a": true, "b": true}, nil)
	assertValidationHasError(t, errs, "deep")
}

func TestValidate_NestedConditions_OuterFalsy(t *testing.T) {
	tpl := handlebars.MustParse("{{#if a}}{{#if b}}{{deep}}{{/if}}{{/if}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"a": false}, nil)
	if len(errs) != 0 {
		t.Errorf("expected no errors, got %v", errs)
	}
}
...
func TestValidate_UnlessBlock(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{"hidden": false}, nil)
	assertValidationHasError(t, errs, "content")
}

func TestValidate_UnlessBlock_Truthy(t *testing.T) {
	tpl := handlebars.MustParse("{{#unless hidden}}{{content}}{{/unless}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"hidden": true}, nil)
	if len(errs) != 0 {
		t.Errorf("expected no errors, got %v", errs)
	}
}
...
func TestValidate_EachBlock_Present(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{
...
func TestValidate_HelperParams(t *testing.T) {
	...
	errs := Validate(tpl.AST(), map[string]interface{}{}, helpers)
...
func TestValidate_EmptyStringIsFalsy(t *testing.T) {
	tpl := handlebars.MustParse("{{#if name}}{{greeting}}{{/if}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"name": ""}, nil)
	if len(errs) != 0 {
		t.Errorf("expected no errors, got %v", errs)
	}
}
...
func TestValidate_ZeroIsFalsy(t *testing.T) {
	tpl := handlebars.MustParse("{{#if count}}{{detail}}{{/if}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"count": 0}, nil)
	if len(errs) != 0 {
		t.Errorf("expected no errors, got %v", errs)
	}
}
...
func TestValidate_NilIsFalsy(t *testing.T) {
	tpl := handlebars.MustParse("{{#if user}}{{user.name}}{{/if}}")
	errs := Validate(tpl.AST(), map[string]interface{}{"user": nil}, nil)
	if len(errs) != 0 {
...
func TestValidate_CollectsAllErrors(t *testing.T) {
	tpl := handlebars.MustParse("{{a}} {{b}} {{c}} {{d}}")
	errs := Validate(tpl.AST(), map[string]interface{}{}, nil)
	if len(errs) != 4 {
...
func TestValidate_NilProgram(t *testing.T) {
	errs := Validate(nil, map[string]interface{}{}, nil)
	if errs != nil {
